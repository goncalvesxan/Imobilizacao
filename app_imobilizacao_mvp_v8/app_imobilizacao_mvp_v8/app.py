...
st.set_page_config(page_title="Motor de Imobilização SAP - MVP V8", layout="wide")
...
st.caption("MVP V8: seleção inteligente CJI3 + marcação de itens já tratados + gestão de chamados + replicação por QTD + template AS01.")
...
with tab_chamados:
    ...
    if chamados.empty:
        ...
        st.download_button(
            ...
            file_name="Gestao_Chamados_MVP_V8.xlsx",
...
with tab_cadastro:
    ...
    if df.empty:
        ...
        if selected_rows.empty:
            ...
            st.dataframe(lote_view, use_container_width=True, height=220, hide_index=True)
...
with tab_template:
    ...
    if not st.session_state.decisoes:
        ...
        st.download_button(
            ...
            data=pacote,
            file_name="Template_AS01_MVP_V8.xlsx",
            mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
            type="primary",
        )
