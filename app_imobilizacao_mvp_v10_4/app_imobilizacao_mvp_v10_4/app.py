...
st.markdown(
    ...
    <div class="hero">
      ...
      <div class="hero-pill">MVP V10.4 • Visual profissional • Grades extensas otimizadas</div>
    </div>
    """,
    unsafe_allow_html=True,
)
...
def _parametros_exportacao(nome_arquivo: str, somente_salvos: bool, incluir_pendencias: bool, template: pd.DataFrame) -> pd.DataFrame:
    return pd.DataFrame([
        {"Parâmetro": "Versão do aplicativo", "Valor": "MVP V10.4"},
    ...
    if chamados.empty:
        ...
        if pep_detalhe:
            ...
            with d1:
                ...
                st.dataframe(detalhe_ch[ch_cols].head(50), use_container_width=True, height=260, hide_index=True)
            with d2:
        ...
        st.download_button(
            ...
            file_name="Gestao_Chamados_MVP_V10_4.xlsx",
