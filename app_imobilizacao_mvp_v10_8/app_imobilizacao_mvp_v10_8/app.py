...
st.markdown(
    ...
    <div class="hero">
      ...
      <div class="hero-pill">MVP V10.8 • Chamados integrados ao cadastro • Visual profissional</div>
    </div>
    """,
    unsafe_allow_html=True,
)
...
def _parametros_exportacao(nome_arquivo: str, somente_salvos: bool, incluir_pendencias: bool, template: pd.DataFrame) -> pd.DataFrame:
    return pd.DataFrame([
        {"Parâmetro": "Versão do aplicativo", "Valor": "MVP V10.7"},
...
with tab_chamados:
    ...
    if chamados.empty:
        ...
        st.download_button(
            ...
            file_name="Gestao_Chamados_MVP_V10_8.xlsx",
...
with tab_template:
    ...
    with p1:
        nome_arquivo = st.text_input("Nome do arquivo Excel", value="Template_AS01_MVP_V10_8.xlsx")
    with p2:
