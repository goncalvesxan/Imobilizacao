...
st.set_page_config(page_title="Motor de Imobilização SAP - MVP V6", layout="wide")
...
st.caption("MVP V6: seleção CJI3 + gestão de chamados + tratamento em lote + template AS01.")
...
with tab_chamados:
    ...
    if chamados.empty:
        ...
        st.download_button(
            ...
            file_name="Gestao_Chamados_MVP_V6.xlsx",
...
with tab_template:
    ...
    if not st.session_state.decisoes:
        ...
        st.download_button(
            ...
            data=pacote,
            file_name="Template_AS01_MVP_V6.xlsx",
            mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
            type="primary",
        )
